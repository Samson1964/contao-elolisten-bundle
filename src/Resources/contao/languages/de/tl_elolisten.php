 ...
 */
$GLOBALS['TL_LANG']['tl_elolisten']['id'] = array('ID', 'ID der Liste');

$GLOBALS['TL_LANG']['tl_elolisten']['title_legend'] = 'Titel';
$GLOBALS['TL_LANG']['tl_elolisten']['listmonth'] = array('Monat', 'Monat der Liste im Format JJJJMM. Wichtig für die interne Zuordnung.');
$GLOBALS['TL_LANG']['tl_elolisten']['title'] = array('Titel', 'Titel der Liste, z.B. Juni 2016. Wird als Überschrift ausgegeben.');
$GLOBALS['TL_LANG']['tl_elolisten']['datum'] = array('Datum', 'Datum der Liste im Format TT.MM.JJJJ');

$GLOBALS['TL_LANG']['tl_elolisten']['publish_legend'] = 'Veröffentlichung';
